                  ...
                  <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom" id="table_container">
                      <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab" style="font-weight:bold; cursor:pointer;"><i class="fa fa-list "></i> MODULO DE GESTION PARA TIPOS DE PRODUCTOS</a></li>
                      </ul>
                        ...
                        <div class="tab-pane active" id="tab_1">
                          ...
                          <div class="box box-success" id="tablacontenidoformasimplificada">
                            <div class="box-header with-border">
                              ...
                              <button class="btn btn-warning" id="btnagregar" onclick="editreg_form();"><i class="fa fa-plus-circle "></i> Registrar un Tipo de Producto</button>
