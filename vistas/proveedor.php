              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <button class="btn btn-warning" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Registrar Proveedor</button>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                      <h1 style="margin-top:-20px; padding-bottom:15px; font-size: 30px;font-family: 'Source Sans Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">Proveedor</h1>
                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <center style="padding-top:250px;">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <button class="btn btn-warning" type="submit" id="btnGuardar"><i class="fa fa-save"></i> Guardar</button>
                              <button style="background:#212c31; color:white;"class="btn" onclick="limpiar()" type="button"><i class="fa fa-refresh"></i> Limpiar</button>
